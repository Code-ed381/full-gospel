                        ...
                        <div className="navbar-collapse">
                            ...
                            <ul className="navbar-nav my-lg-0">
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end mailbox scale-up">
                                        <ul>
                                            <li>
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu mailbox dropdown-menu-end scale-up" aria-labelledby="2">
                                        <ul>
                                            <li>
                                ...
                                <!-- End User Profile -->
                                <!-- ============================================================== --> */}
                                <li className="nav-item right-side-toggle"> <a class="nav-link  waves-effect waves-light" href="javascript:void(0)"><i class="ti-settings"></i></a></li>
                            </ul>
                        </div>
                    </nav>
                </header>
            ...
            <aside class="left-sidebar">
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            <li className="user-pro"> <a className="has-arrow waves-effect waves-dark active" href="javascript:void(0)" aria-expanded="false"><img src="../assets/images/users/1.jpg" alt="user-img" className="img-circle"/><span className="hide-menu">Mark Jeckson</span></a>
                                <ul aria-expanded="false" className="collapse">
                                    <li><a href="events"><i className="ti-user"></i>All Events</a></li>
                            ...
                            <li className="nav-small-cap">--- EVENTS</li>
                            <li> <Link className="waves-effect waves-dark" to="dashboard" aria-expanded="false"><i className="icon-speedometer"></i><span className="hide-menu">Dashboard</span></Link></li>

                            <li> <Link className="has-arrow waves-effect waves-dark" to="events" aria-expanded="false"><i className="ti-layout-grid2"></i><span className="hide-menu">Events</span></Link></li>
